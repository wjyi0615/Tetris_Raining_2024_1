...
int main() {
	srand(time(NULL));
	SetConsoleTitle(TEXT("TETRIS 7조: 푸앙이와  함께하는 세계여행"));
...
void ShowStory() {
	...
	if (isShowStory == false) {
		...
		gotoxy(31, 5);
		printf(FG_COLOR(255, 255, 0) "\" 세계일주를 하고 싶어하는 푸앙이! \"" RESET);
		gotoxy(14, 9);
		printf(FG_COLOR(255, 255, 0) "\" 푸앙이는 국내 최고의 여행 유튜버가 되기 위해 여행을 떠난다. \"" RESET);

		gotoxy(20, 16);
		printf("여러분들은 푸앙이가 최고의 여행 유튜버가 될수있도록 도와주세요!");
		gotoxy(14, 19);
		printf("3가지 지역의 3가지 나라를 모두 여행하여 세계최고의 여행 유튜버이 되길 바랍니다!");
		isShowStory = true;
...
void MenuThree() // 제작자 메뉴
{
	...
	printf("중앙대학교 소프트웨어학부, 경영학부 ");
	gotoxy(Width / 2 - 7, Height / 2 + 1);
	printf("서현도, 이우중, 이준우, 조예연");
...
{
	gotoxy(10, 1);
	printf(FG_COLOR(255, 0, 0) "세 " RESET);
	printf(FG_COLOR(255, 127, 0) "계 " RESET);
	printf(FG_COLOR(255, 255, 0) "여 " RESET);
	printf(FG_COLOR(0, 255, 0) "행 " RESET);
	printf(FG_COLOR(0, 255, 255) "중 " RESET);
	printf(FG_COLOR(148, 0, 211) "★" RESET);
	gotoxy(12, 4);
...
{
	for (int j = 0; j < 10; j++) {
		int color = space[line][j + 1] - 1;
		if (colorGauge[color] >= 0) {
	...
	if (isStageClear == true) {
		...
		if (themenum == 1) {
			if (stagenum == 1) {
				...
				Console_Size();
				gotoxy(Width / 2 - 12, 2);
				printf(FG_COLOR(255, 255, 0) "< 일본 >  " RESET);
				printf("おはよう ございます。 (오하요 고자이마스) ");
				Japan(20, 5);
			}
			else if (stagenum == 2) {
				Height = 37;
				Console_Size();
				gotoxy(Width / 2 - 11, 2);
				printf(FG_COLOR(255, 255, 0) "< 중국 >  " RESET);
				printf("你好! (니 하오) ");
				China(8, 5);
			}
			else if (stagenum == 3) {
				...
				Console_Size();
				gotoxy(Width / 2 - 12, 2);
				printf(FG_COLOR(255, 255, 0) "< 베트남 >  " RESET);
				printf("xin chao (씬 짜오)");
				Catarrh(12, 5);
			}
		}
		else if (themenum == 2) {
			if (stagenum == 1) {
				...
				Console_Size();
				gotoxy(Width / 2 - 13, 2);
				printf(FG_COLOR(255, 255, 0) "< 잉글랜드 >  " RESET);
				printf("Hello !!");
				England(14, 5);
			}
			else if (stagenum == 2) {
				...
				Console_Size();
				gotoxy(Width / 2 - 13, 2);
				printf(FG_COLOR(255, 255, 0) "< 프랑스 >  " RESET);
				printf("봉쥬르");
				France(10, 5);
			}
			else if (stagenum == 3) {
				...
				Console_Size();
				gotoxy(Width / 2 - 12, 2);
				printf(FG_COLOR(255, 255, 0) "< 독일 >  " RESET);
				printf("구텐타 !!");
				Germany(14, 7);
			}
		}
			...
			if (stagenum == 1) {
				...
				Console_Size();
				gotoxy(Width / 2 - 11, 2);
				printf(FG_COLOR(255, 255, 0) "< 브라질 >  " RESET);
				printf("조리법 획득 !!");
				Brazil(24, 5);
			}
			else if (stagenum == 2) {
				...
				Console_Size();
				gotoxy(Width / 2 - 14, 2);
				printf(FG_COLOR(255, 255, 0) "< 아르헨티나 >  " RESET);
				printf("조리법 획득 !!");
				Argentina(33, 5);
			}
			else if (stagenum == 3) {
				...
				Console_Size();
				gotoxy(Width / 2 - 12, 2);
				printf(FG_COLOR(255, 255, 0) "< 칠레 >  " RESET);
				printf("조리법 획득 !!");
				Chile(20, 5);
			}
		}
		...
		if (stagenum == 4) {
			...
			gotoxy(Width / 2 - 12, 2);
			if (themenum == 1) printf(FG_COLOR(255, 255, 0) "< 아시아 >  " RESET);
			else if (themenum == 2) printf(FG_COLOR(255, 255, 0) "< 유럽 >  " RESET);
			else printf(FG_COLOR(255, 255, 0) "< 남미 >  " RESET);
			printf("당신은 여행 마스터 !!\n");
			printf("여행 유튜버를 해도 성공 하시겠는 걸요??");
			Puang(5, 5);
